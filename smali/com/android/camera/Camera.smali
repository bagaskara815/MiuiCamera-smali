...
.field public static final CTA_REQUEST_QUIT_FROMUSER:I = 0x29a
...
.method public constructor <init>()V
    ...
    .line 16
    new-instance v4, LOooO0O0/OooO0O0/OooO00o/OooO0o0;

    invoke-direct {v4, p0}, LOooO0O0/OooO0O0/OooO00o/OooO0o0;-><init>(Lcom/android/camera/Camera;)V
...
.method private requestCtaDialog()V
    ...
    const-string v5, "miui.intent.action.SYSTEM_PERMISSION_DECLARE_NEW"
    ...
    const-string/jumbo v0, "optional_perm"
    ...
    const-string/jumbo v0, "optional_perm_desc"
...
.method private resumeCamera(Z)V
    ...
    invoke-direct {v3, v0, v1}, LOooO0O0/OooO0O0/OooO00o/OooO0OO;-><init>(Lcom/android/camera/Camera;Lcom/android/camera/module/loader/StartControl;)V
...
.method public createActivity(Landroid/os/Bundle;)V
    ...
    .line 2
    invoke-direct {p0}, Lcom/android/camera/Camera;->startBoost()V
    ...
    invoke-static {v0}, Lcom/android/camera2/compat/theme/MiThemeCompat;->create(Landroid/content/Context;)V
    ...
    .line 14
    invoke-super {p0, v3}, Lcom/android/camera/ActivityBase;->createActivity(Landroid/os/Bundle;)V
    ...
    .line 18
    :goto_0
    invoke-static {p0, v2}, Lcom/android/camera/display/Display;->init(Landroid/content/Context;Z)V
    ...
    invoke-virtual {v6}, Lcom/android/camera/CameraIntentManager;->isFromVolumeKey()Ljava/lang/Boolean;
    ...
    .line 26
    iput-boolean v4, p0, Lcom/android/camera/Camera;->mIntentPhotoDone:Z
    ...
    const-string/jumbo v2, "setColorMode(ActivityInfo.COLOR_MODE_WIDE_COLOR_GAMUT)"
    ...
    invoke-direct {p1, v1}, Lcom/google/lens/sdk/LensApi;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v1}, LOooO0O0/OooO0Oo/OooO00o/OooO00o;->o0OO0o()Z

    move-result v1

    .line 72
    invoke-virtual {p1, v1}, LOooO0O0/OooO0O0/OooO0Oo/OooO0Oo;->OooO00o(Z)V
    ...
    const-string/jumbo v1, "onCreate: remote device id = "
    ...
    .line 81
    iput-boolean v4, p0, Lcom/android/camera/Camera;->mRemoteControlConnected:Z
    ...
    .line 87
    invoke-direct {p0}, Lcom/android/camera/Camera;->stopBoost()V
...
.method public destroyActivity()V
    ...
    .line 35
    :cond_e
    invoke-static {}, Lcom/android/camera2/compat/theme/MiThemeCompat;->destroy()V
...
.method public handleScreenSlideKeyEvent(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v6}, LOooO0O0/OooO0Oo/OooO00o/OooO00o;->o00ooo00()Z
...
.method public notifyOnFirstFrameArrived(I)V
    ...
    invoke-direct {v2, p0}, LOooO0O0/OooO0O0/OooO00o/OooO0o;-><init>(Lcom/android/camera/Camera;)V
    ...
    instance-of p1, p1, Lcom/android/camera/dualvideo/DualVideoGridModule;

    const/4 v0, 0x1

    if-eqz p1, :cond_4

    iget-object p1, p0, Lcom/android/camera/Camera;->lastModule:Lcom/android/camera/module/Module;
    ...
    .line 11
    invoke-virtual {p1}, Lcom/android/camera/dualvideo/DualVideoModuleBase;->isRecordSuccess()Z
    ...
    invoke-virtual {p1, v2, v3, v0}, Lcom/android/camera/aftersales/AftersalesManager;->count(JI)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/ui/RenderEngineAdapter;->setAnimationType(I)V
...
.method public showGuide(I)V
    ...
    invoke-virtual {p1}, LOooO0O0/OooO0Oo/OooO00o/OooO00o;->o00o00()Z
